package com.homework.corefinalproject.parser.formula;

import com.homework.corefinalproject.parser.SupportedOperators;
...
public class FormulaParser {
    ...
    private void addToParsedFormulaText(String text, SymbolCategory elementType) {
        ...
        if (text.equals("-")
                ...
                || previousElementType.equals(SymbolCategory.OPEN_BRACKET))){
    ...
    public void convertParsedTextIntoFormulaElements() {
        ...
        //System.out.println(formulaIN.toString());
    }
    ...
    private SupportedOperators findSupportedOperator(String text) {
        ...
        if (operator != null) {
            ...
            throw new UnsupportedOperationException("Error in function formula: " + text);
        }
    }
